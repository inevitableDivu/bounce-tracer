        ...
        >
            ...
            <View style={styles.row}>
                ...
                <Text style={styles.value}>
                    {telemetry.processingTimeMs.toFixed(2)} ms
                </Text>
            </View>
            <View style={styles.row}>
                <Text style={styles.label}>Target X:</Text>
                <Text style={styles.value}>
                    {telemetry.predictedXLand.toFixed(1)} px
                </Text>
            </View>
            <View style={styles.row}>
                <Text style={styles.label}>Velocity (Vx, Vy):</Text>
                <Text style={styles.value}>
                    ({telemetry.velocityX.toFixed(0)},{" "}
                    {telemetry.velocityY.toFixed(0)})
                </Text>
            </View>
            <View style={styles.row}>
                ...
                <Text
                    style={[
                        styles.value,
                        telemetry.isTracking ? styles.tracking : styles.idle,
                    ]}
                >
            ...
            >
                <Text style={styles.buttonText}>
                    {isActive ? "PAUSE BOT" : "START AUTOMATION"}
                </Text>
            </TouchableOpacity>
        </View>
    );
